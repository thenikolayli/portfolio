                ...
                <div class="container hidden sm:block">
                    <div class="absolute flex justify-self-center inset-x-0 w-fit h-fit p-4 space-x-8 font-code text-xl">
                        ...
                        <div class="flex z-10 flex-col p-1 items-center hover:shadow-lg transition duration-300"
                            ...
                            <div class={clsx("absolute z-0 top-0 container w-fit pt-12 space-y-3 p-4 backdrop-blur transition duration-300", {
                    ...
                    <div class="absolute flex right-4 w-fit h-fit p-4 font-ibm text-xl">
                        ...
                        <div class={clsx("container space-x-4", {"hidden": !getUsername()})}>
                            ...
                            <a class="p-1 hover:shadow-lg transition duration-300" href="#" onClick={context.logout}>logout</a>
                        </div>
                    </div>
                </div>
