...
<section class="relative">
    ...
    >
        <img width="100px" height="100px" bind:this={original} src={src} alt={name} class="relative z-[0] w-full h-full object-contain">
        <img width="100px" height="100px" bind:this={filtered} src={src} alt={name} class="absolute z-[1] top-4 left-4 z-0 object-contain">
    </div>
